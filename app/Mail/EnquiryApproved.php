...
class EnquiryApproved extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "Great News! Your enquiry has been approved - {$this->enquiry->resource->name}",
